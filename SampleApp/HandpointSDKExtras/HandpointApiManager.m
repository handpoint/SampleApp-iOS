...
@property (nonatomic, copy, nullable) DeviceDiscoveryFinished globalDeviceDiscoveryBlock;
...
- (void)requestSignature:(NSString *)receipt
{
    ...
    //To simplify, we ALWAYS accept the signature.
    [self signatureResult:YES];
}
...
- (void)sendScannerResults:(NSArray *)scannedCodes
{
    ...
    [self.delegate scannedCodes:scannedCodes];
}
